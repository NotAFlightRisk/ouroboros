...
Invoke `/ouroboros:welcome` with the user's arguments and follow that skill exactly.
This is the explicit Marketplace-plugin entry point for a bare `ooo` message
before any runtime-specific setup has run.
