    ...
    def definition(self) -> MCPToolDefinition:
        ...
        return MCPToolDefinition(
            ...
            description=(
                ...
                "`consent_status: not_confirmable_prose_not_retained` (a replay, "
                "or a completion assembled from lanes accumulated in earlier "
                "calls) is NOT ready to forward as a data-derived answer — "
                "re-run the advisory fan-out to obtain a confirmable one. "
                "Submissions are "
