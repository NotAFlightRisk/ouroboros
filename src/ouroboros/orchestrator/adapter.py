...
class ClaudeAgentAdapter:
    ...
    async def execute_task(
        ...
        model: str | None = None,
        *,
        _execution_controller: Any | None = None,
    ) -> AsyncIterator[AgentMessage]:
        ...
        try:
            # The bidirectional client exposes interrupt/disconnect and lets us
            # acquire its subprocess before sending the first provider prompt.
