...
class TestGjcSetup:
    ...
    def test_register_gjc_mcp_refreshes_setup_managed_entry_with_force(self) -> None:
        listed = subprocess.CompletedProcess(
            ["gjc", "mcp", "list", "--json"],
            0,
            stdout=json.dumps(
        ...
        assert "--force" in run.call_args_list[1].args[0]
